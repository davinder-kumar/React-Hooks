    ...
    switch (action.type) {
        ...
        case "RESPONSE":
            return {
                ...state, loading: false, 
                error: null, 
                data: action.data, actionName: action.actionName
            }
        case "ERROR":
            return {
...
const useHttp = () => {
    ...
    const sendRequest = useCallback((url, method, body, actionName, reqData) => {
